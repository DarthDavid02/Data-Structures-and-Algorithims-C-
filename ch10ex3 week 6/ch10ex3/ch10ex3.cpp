...
void calculateCost()
{
    double breadCost, meatCost, cheeseCost, bakedCost = 0;
    string bread, meat, cheese, vegetable, condiment, answer;
    ...
    cout << "Type Yes if you want baked bread. ";
    cin >> answer;
    ...
    //new code for week 6 Inheritance assignment for choice for baked bread
    if (sub.getBaked() == "Yes")
    {
        bakedCost = 0.75;
    }
    ...
    //new code for week 6 Inheritance assignment for totalCost
    double totalCost = cost * sub.getLengthInFeet() * bakedCost;
